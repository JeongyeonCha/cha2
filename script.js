// 제품 데이터 배열
const products = [
    { title: "GRANHAND_multi Perfume", image: "그랑핸드_퍼퓸.png", description: "음 향기롭군..."  },
    { title: "COS_ribbed alpaca blend beanie", image: "비니.png", description:"비니는 진짜 유명한 패션 아이템임 그러나 이마를 벅벅 긁게 될 수 있기에 피가 나지 않도록 주의해야 한다" },
    { title: "ENZO BLUES_sleeve muffler", image: "목도리.png", description:"니트의 소매처럼 생겼지만 놀랍게도 이것은 머플러이다. 이러한 디자인은 사람들의 호기심을 자극하여 만나는 사람마다 머플러의 끝에 손을 넣어볼 확률이 높으며 이에 따라 끝단이 금새 늘어나버린다" },
    { title: "GRANHAND_sachet", image: "사쉐.png", description:"사쉐를 집에 걸어두면 귀가본능이 더욱 강해진다" },
